      ...
      <div className="max-w-2xl text-center p-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          <p className="text-lg text-gray-700">
            Don&#39;t worry, we&#39;re redirecting you to our{' '}
            <span className="text-blue-600 font-medium">Home Page</span> in{' '}
            <strong className="text-2xl text-blue-600">{countdown}</strong> seconds.
          </p>
