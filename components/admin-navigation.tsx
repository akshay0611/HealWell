...
import { LayoutDashboard, Calendar, User, Clock, Settings, BookOpen, LogOut, Handshake, Briefcase, Users} from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className="absolute top-4 -right-4 bg-white shadow-md rounded-full z-10"
      >
        {isExpanded ? '<' : '>'}
      </Button>
